...
class App extends Component {
  state = {
    ...
    navMessage: "Click any card to start!",
  ...
  // passes the randomized state.allCards array to Container to create a Character component for each image.
